...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget get textFormFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style:
              textStyle ?? CustomTextStyles.titleLargeInterBlack900ExtraLight,
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        fillColor: fillColor ?? appTheme.blueGray100.withOpacity(0.21),
        filled: filled,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlinePrimaryTL20 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(20.h),
        borderSide: BorderSide(
          color: theme.colorScheme.primary,
          width: 1,
  ...
  static OutlineInputBorder get outlinePrimaryTL201 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(20.h),
        borderSide: BorderSide(
          color: theme.colorScheme.primary,
          width: 1,
